$(function() {
  $(".safety_concern-fields .nested-fields").each(function(_, element) {
    updateForm(element);
  });

  $(".response_plan_safety_concerns_category input").on("click", function(event) {
  ...
  function updateForm(form, value) {
    form = $(form);
    var category_radios = form.find(".response_plan_safety_concerns_category");
    var physical_threat_node = form.find(".response_plan_safety_concerns_physical_or_threat");
