class CreateRmsCrisisIncidents < ActiveRecord::Migration
  def change
    create_table :rms_crisis_incidents do |t|
      t.references :rms_person, index: true, foreign_key: true, null: false
